SELECT
  ...
  S.Ac_Name_E AS customer,
  dbo.NT_1_BrandMaster.Brand_Name,
  dbo.NT_1_qryJogerryitemmaster.System_Name_E AS ItemName
FROM
  dbo.NT_1_BrandMaster
  JOIN dbo.NT_1_AwakDetail
  JOIN dbo.nt_1_accountmaster AS S ON dbo.NT_1_AwakDetail.Cust_Code = S.Ac_Code
  AND dbo.NT_1_AwakDetail.Company_Code = S.company_code;