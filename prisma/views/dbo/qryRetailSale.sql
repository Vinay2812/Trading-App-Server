SELECT
  ...
  dbo.Retail_Detail.Detail_Id,
  dbo.Retail_Detail.Item_Code,
  dbo.Retail_Detail.Brand_Code,
  dbo.Retail_Detail.Qty,
  dbo.Retail_Detail.Wtper,
  dbo.Retail_Detail.Netkg,
  dbo.Retail_Detail.Rate,
  dbo.Retail_Detail.Value,
  dbo.Retail_Detail.Market_Cess,
  dbo.Retail_Detail.Super_Cost,
  dbo.Retail_Detail.Packing,
  dbo.Retail_Detail.Hamali,
  dbo.Retail_Detail.Freight,
  dbo.Retail_Detail.Other,
  dbo.Retail_Detail.Taxable_Amount AS Taxable_Amount1,
  dbo.Retail_Detail.GST_Code,
  dbo.Retail_Detail.GST,
  dbo.Retail_Detail.Net_Value,
  ...
  dbo.Retail_Detail.CGST_Rate AS CGSTRate,
  dbo.Retail_Detail.CGST_Amount AS CGSTAmount,
  dbo.Retail_Detail.SGST_Rate AS SGSTRate,
  dbo.Retail_Detail.SGST_Amount AS SGSTAmount,
  dbo.Retail_Detail.IGST_Rate AS IGSTRate,
  dbo.Retail_Detail.IGST_Amount AS IGSTAmount,
  party.GSTStateCode,
  dbo.Retail_Head.CashCredit,
  NT_1_AccountMaster_1.Ac_Name_E AS brokername,
  dbo.Retail_Head.Party_name_new,
  dbo.Retail_Detail.Salerate,
  ...
  dbo.Retail_Detail.retaildid,
  dbo.Retail_Detail.ic,
  dbo.Retail_Detail.saleac,
  dbo.Retail_Detail.sid,
  dbo.Retail_Head.pc,
  dbo.Retail_Head.st,
  dbo.Retail_Head.bc,
  dbo.Retail_Head.pcn,
  ...
  party.FSSAI AS BillToFSSAI,
  party.Tan_no AS BillToTan,
  shipto.FSSAI AS ShipToFSSAI,
  shipto.Tan_no AS ShipToTan,
  dbo.Retail_Head.TDS_Rate,
  dbo.Retail_Head.TDS_Amt,
  dbo.Retail_Head.QRCode,
  SUM(dbo.Retail_Detail.Qty) AS quantity,
  party.Email_Id AS partyEmail_Id
FROM
  dbo.gststatemaster
  ...
  LEFT JOIN dbo.nt_1_accountmaster ON dbo.Retail_Head.Party_name_new = dbo.nt_1_accountmaster.Ac_Code;