SELECT
  ...
  dbo.NT_1_Awakhead.levi AS Expr4,
  ...
  dbo.NT_1_AwakDetail.Poch_Rate,
  dbo.NT_1_AwakDetail.Frieght_Rate
FROM
  dbo.nt_1_accountmaster AS customer
  LEFT JOIN dbo.NT_1_BrandMaster
  JOIN dbo.NT_1_AwakDetail ON dbo.NT_1_BrandMaster.Doc_No = dbo.NT_1_AwakDetail.Brand_Code
  AND dbo.NT_1_BrandMaster.Company_Code = dbo.NT_1_AwakDetail.Company_Code
  LEFT JOIN dbo.NT_1_Awakhead ON dbo.NT_1_AwakDetail.Year_Code = dbo.NT_1_Awakhead.Year_Code
  ...
  LEFT JOIN dbo.nt_1_systemmaster AS hamali ON dbo.NT_1_AwakDetail.Hamali_Code = hamali.System_Code
  AND dbo.NT_1_AwakDetail.Company_Code = hamali.Company_Code
  LEFT JOIN dbo.nt_1_systemmaster AS packing ON dbo.NT_1_AwakDetail.Packing_Code = packing.System_Code
  AND dbo.NT_1_AwakDetail.Company_Code = packing.Company_Code
  LEFT JOIN dbo.nt_1_systemmaster AS item ON dbo.NT_1_AwakDetail.Item_Code = item.System_Code
