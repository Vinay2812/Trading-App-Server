SELECT
  ...
  dbo.NT_1_Awakhead.Cess,
  S.Ac_Name_E AS Supplier,
  C.Ac_Name_E AS Customername,
...
FROM
  ...
  RIGHT JOIN dbo.NT_1_qryJogerryitemmaster
  RIGHT JOIN dbo.NT_1_AwakDetail ON dbo.NT_1_qryJogerryitemmaster.System_Code = dbo.NT_1_AwakDetail.Item_Code
  AND dbo.NT_1_qryJogerryitemmaster.Company_Code = dbo.NT_1_AwakDetail.Company_Code;